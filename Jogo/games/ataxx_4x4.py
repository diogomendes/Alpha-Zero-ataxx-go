...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape=(3,4,4) # Dimensions (number of diferent values (player1,player2, empty), height,width)
        self.action_space=list(range(16)) #all possible actions 
        ...
        self.max_moves=20  # max moves permited if game is not finished before  (adapt on diferent boards)
        ...
        self.training_steps=8000000                      # total number of training steps  
...
class Ataxx:
    ...
    # agent that could train against Muzero
